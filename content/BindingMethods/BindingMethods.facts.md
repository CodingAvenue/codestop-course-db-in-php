...
- `:first_name`, `$data['first_name']`, `:birth_date`, `1999-06-30`, and `PDO::PARAM_STR` are arguments to be passed in the `bindValue()` method.

- `:first_name` and `:birth_date` represent the parameter name as the parameter identifier for named placeholders as parameters.
